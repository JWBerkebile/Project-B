...
<body>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
        ...
        <h1 class="display-3">Machine Name Search</h1>
...
$machSearch = htmlspecialchars($_POST['machSearch']);

//Database connection
require_once("databaseConnect.php");

$sql = "SELECT id, partName, partNumber, manufacturer, machineName, cost, Quantity, cost * Quantity as Total FROM content WHERE machineName LIKE '%$machSearch%'";  //Select everything from content table matching entered manchine name
