...
<body>
  ...
  <div class="container">
    ...
    <header class="jumbotron my-4">
        ...
        <h1 class="display-3">Part Name Search</h1>
...
$sql = "SELECT id, partName, partNumber, manufacturer, machineName, cost, Quantity, cost * Quantity as Total FROM content WHERE partName LIKE '%$nameSearch%'";  //Select everything from content table matching entered part name
